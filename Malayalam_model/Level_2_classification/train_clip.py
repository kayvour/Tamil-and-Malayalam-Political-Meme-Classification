...
def main():
    print("="*80)
    print("MALAYALAM MEME CLASSIFICATION - LEVEL 2 CLIP TRAINING")
    print("="*80)
    ...
    model = CLIPMemeClassifier(num_classes=len(unique_labels)).to(device)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save({'model_state_dict': model.state_dict(), 'label_map': label_map}, 'best_clip_level2_model.pth')
